...
<table class="container table-auto w-full rounded-lg border-2 border-orange-500 bg-white mt-5 w-99 text-center">
    <thead class="bg-orange-500 text-white">
      <tr>
        ...
        <th><button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">
          crear
        </button><button class="bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">
          Eliminar
        </button>
      </tr>
    </thead>
    <tbody>
      <tr class="bg-orange-100">
        ...
        <td>34654</td>
        <td>34654</td>
        <td><button class="bg-yellow-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">
          Modificar
        </button>
